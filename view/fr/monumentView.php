		...
		<div class="row">
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#notredame">
					<img src="public/images/notredame.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>Notre-Dame</p>
			</div>
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#conciergerie">
					<img src="public/images/conciergerie.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>La Conciergerie</p>
			</div>
		</div><br>
		<div class="row">
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#saintechapelle">
					<img src="public/images/saintechapelle.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>La Sainte Chapelle</p>
			</div>
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#tribunalcommerce">
					<img src="public/images/tribunalcommerce.jpg" class="img-circle" width="200" height="200">
				</a>
		...
		<div class="row">
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#hoteldieu">
					<img src="public/images/hoteldieu.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>Hôtel Dieu</p>
			</div>
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#memorial">
					<img src="public/images/memorialdesmartyrs.jpg" class="img-circle" width="200" height="200">
				</a>
		...
		<div class="row">
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#pontneuf">
					<img src="public/images/pontneuf.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>Pont Neuf</p>
			</div>
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#pontnotredame">
					<img src="public/images/pontnotredame.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>Pont Notre-Dame</p>
			</div>
		</div><br>
		<div class="row">
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#pontaudouble">
					<img src="public/images/pontaudouble.jpg" class="img-circle" width="200" height="200">
				</a>
				<p>Pont au double</p>
			</div>
			<div class="col-md-6">
				<a data-toggle="modal" data-target="#pontsaintmichel">
					<img src="public/images/pontsaintmichel.jpg" class="img-circle" width="200" height="200">
				</a>
		...
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/notredame.jpg" width="50%" height="50%"><br><br>
	...
	<div class="modal fade" id="conciergerie" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/conciergerie.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
	...
	<div class="modal fade" id="saintechapelle" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/saintechapelle.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
	...
	<div class="modal fade" id="tribunalcommerce" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/tribunalcommerce.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
	...
	<div class="modal fade" id="hoteldieu" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/hoteldieu.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
	...
	<div class="modal fade" id="memorial" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/memorialdesmartyrs.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
						TODO: Faire le texte
					</p>
				</div>
	...
	<div class="modal fade" id="pontneuf" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/pontneuf.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
						TODO: Faire le texte
					</p>
				</div>
	...
	<div class="modal fade" id="pontnotredame" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/pontnotredame.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
						TODO: Faire le texte
					</p>
				</div>
	...
	<div class="modal fade" id="pontaudouble" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/pontaudouble.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
						TODO: Faire le texte
					</p>
				</div>
	...
	<div class="modal fade" id="pontsaintmichel" role="dialog">
		<div class="modal-dialog">
			<div class="histoire modal-content">
				...
				<div class="modal-body text-center">
					<img src="public/images/pontsaintmichel.jpg" width="50%" height="50%"><br><br>
					<p class="text-justify">
						TODO: Faire le texte
					</p>
				</div>
