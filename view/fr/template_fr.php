				...
				<div class="row">
					<div class="footer-col col-md-12" style="margin-left: 25%">
						<ul class="nav navbar-nav image-footer">
							<li><img src="public/images/icomos.png" class="img-responsive" title="Icomos International" alt="Icomos International"></li>
							<li><img src="public/images/upem.png" class="img-responsive" title="Université Paris Est Marne la Vallée" alt="Université Paris Est Marne la Vallée"></li>
							<li><img src="public/images/unesco.svg" class="img-responsive" title="UNESCO" alt="UNESCO"></li>
						</ul>
					</div>
				</div><hr>
				<div class="row">
