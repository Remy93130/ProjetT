	...
	<div class="container">
		...
		<div class="row">
			<div class="list-group">
				...
				<div class="list-group-item">
					<table>
						<tr>
							<th>
								<img src="../images/voyageur1.jpg" class="table-col2" alt="Image1">
								<p class="text-center">Mur de l'Hôtel Dieu</p>
							</th>
							<th>
			...
			<div class="list-group text-center">
				<h2 class="list-group-item active">La fausse vieille maison médiévale</h2>
				<div class="list-group-item">
					<table>
						<tr>
							<th>
			...
			<br>
			<div class="list-group text-center">
				<h2 class="list-group-item active">Le mystère de la statue d'Henri IV</h2>
				<div class="list-group-item">
					<table>
						<tr>
							<th>
								<img src="../images/voyageur3.jpg" class="table-col2" alt="Image3">
								<p class="text-center">La statue de Henri IV</p>
							</th>
							<th>
								<p class="text-justify table-col2">
