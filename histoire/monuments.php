...
<div class="container text-center">
	...
	<div class="row">
			...
			<div class="modal fade" id="Hotel-Dieu" role="dialog">
				<div class="modal-dialog">
					...
					<div class="histoire modal-content">
						...
						<div class="modal-body">
							<img src="../images/hotel_dieu.jpg" width="50%" height="50%" title="L'Hôtel-Dieu"> <br> <br>
							<p class="text-justify">
		...
		<div class="col-md-6">
			<img src="../images/memorialdesmartyrs.jpg" class="img-circle" width="200" height="200" data-toggle="modal" data-target="#memorial_des_martyrs" title="Cliquez pour découvrir le monument"> 
			<p>Mémorial des Martyrs</p>
			<!-- Modal -->
			<div class="modal fade" id="memorial_des_martyrs" role="dialog">
				<div class="modal-dialog">
					<!-- contenu-->
					<div class="histoire modal-content">
						<div class="modal-header">
							<h2 class="modal-title text-center">Mémorial des Martyrs</h2>
						</div>
						<div class="modal-body">
							<img src="../images/memorialdesmartyrs.jpg" width="50%" height="50%" title="Mémorial des Martyrs"> <br> <br>
							<p class="text-justify">
								blabla
							</p>
							<button data-toggle="collapse" data-target="#memorial_des_martyrs_plus" class="button-more">en savoir plus...</button>
							</p>
							<div id="memorial_des_martyrs_plus" class="collapse"> 
								<p class="text-justify">
									blabla
								</p>
							</div>
...
<div class="container text-center">
	<div class="row">
		<div class="col-md-6">
			<img src="../images/pontneuf.jpg" class="img-circle" width="200" height="200" data-toggle="modal" data-target="#pontneuf" title="Cliquez pour découvrir le monument">
			<p>Pont Neuf</p>
			<!-- Modal -->
			<div class="modal fade" id="pontneuf" role="dialog">
				<div class="modal-dialog">
					...
					<div class="histoire modal-content">
						<div class="modal-header">
							<h2 class="modal-title text-center">Pont Neuf</h2>
						</div>
						<div class="modal-body">
							<img src="../images/pontneuf.jpg" width="50%" height="50%" title="Pont Neuf"> <br> <br>
							<p class="text-justify">
								blabla
							</p>
							<button data-toggle="collapse" data-target="#pontneuf_plus" class="button-more">En savoir plus...</button>
							<div id="pontneuf_plus" class="collapse"> 
								<p class="text-justify">
									blabla
								</p>
							</div>
		...
		<div class="col-md-6">
			<img src="../images/pontnotredame.jpg" class="img-circle" width="200" height="200" data-toggle="modal" data-target="#pont_notredame" title="Cliquez pour découvrir le monument">
			<p>Pont Neuf</p>
			<!-- Modal -->
			<div class="modal fade" id="pont_notredame" role="dialog">
				<div class="modal-dialog">
					<!-- contenu-->
					<div class="histoire modal-content">
						<div class="modal-header">
							<h2 class="modal-title text-center">Pont Notre-Dame</h2>
						</div>
						<div class="modal-body">
							<img src="../images/pontnotredame.jpg" width="50%" height="50%" title="Pont Notre-Dame"> <br> <br>
							<p class="text-justify">
								blabla
							</p>
							<button data-toggle="collapse" data-target="#pont_notredame_plus" class="button-more">En savoir plus...</button>
							<div id="pont_notredame_plus" class="collapse"> 
								<p class="text-justify">
									blabla
								</p>
							</div>
	...
	<div class="row">
		<div class="col-md-6">
			<img src="../images/pontaudouble.jpg" class="img-circle" width="200" height="200" data-toggle="modal" data-target="#pont_au_double" title="Cliquez pour découvrir le monument">
			<p>Pont au double</p>
			<!-- Modal -->
			<div class="modal fade" id="pont_au_double" role="dialog">
				<div class="modal-dialog">
					<!-- contenu-->
					<div class="histoire modal-content">
						<div class="modal-header">
							<h2 class="modal-title text-center">Pont au double</h2>
						</div>
						<div class="modal-body">
							<img src="../images/pontaudouble.jpg" width="50%" height="50%" title="Pont au double"> <br> <br>
							<p class="text-justify">
								blabla
							</p>
							<button data-toggle="collapse" data-target="#pont_au_double_plus" class="button-more">En savoir plus...</button>
							<div id="pont_au_double_plus" class="collapse"> 
								<p class="text-justify">
									blabla
								</p>
							</div>
		...
		<div class="col-md-6">
			<img src="../images/pontsaintmichel.jpg" class="img-circle" width="200" height="200" data-toggle="modal" data-target="#pont_saint_michel" title="Cliquez pour découvrir le monument">
			<p>Pont Saint Michel</p>
			<!-- Modal -->
			<div class="modal fade" id="pont_saint_michel" role="dialog">
				<div class="modal-dialog">
					<!-- contenu-->
					<div class="histoire modal-content">
						<div class="modal-header">
							<h2 class="modal-title text-center">Pont Saint Michel</h2>
						</div>
						<div class="modal-body">
							<img src="../images/pontsaintmichel.jpg" width="50%" height="50%" title="Pont Saint Michel"> <br> <br>
							<p class="text-justify">
								blabla
							</p>
							<button data-toggle="collapse" data-target="#pont_saint_michel_plus" class="button-more">En savoir plus...</button>
							<div id="pont_saint_michel_plus" class="collapse"> 
								<p class="text-justify">
									blabla
								</p>
							</div>
